      ...
      <div className="Container">
        ...
        <div className="Navigation">
            ...
            <div className="Navigation-sub">
              <Link to='/home' className="Nav-left"><h2><span className="silver">C</span><span className="">|</span><span className="silver">V</span></h2></Link>
              {/* Set up the links */}
              <Link to='/about' className="Sub-item nav-font">_About</Link>
              <Link to='/home' className="Sub-item nav-font">_Work</Link>
            </div>
        </div>
